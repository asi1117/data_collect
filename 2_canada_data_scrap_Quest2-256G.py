'''
此方法是 canada_data_scrap_Quest2-256G 的第二中方法，不用pandas的方法，爬取了best buy上加拿大的oculus-quest2-256G的設備評論
直接用csv
'''
...
if __name__ == '__main__':
    ...
    with open('1BestBuy_Canada_Oculus_Quest2_reviews256G.csv','w',encoding='utf-8_sig',newline='') as f: #注意要這個裏面的屬性 newline是刪除空行
        writer = csv.writer(f)
